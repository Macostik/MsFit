...
class HistoryCell: UITableViewCell, CellIdentifierable {
    ...
    private let dateLabel = Label(icon: "", font: .systemFont(ofSize: 16, weight: .regular),
                                  textColor: #colorLiteral(red: 0.1490000039, green: 0.1490000039, blue: 0.1689999998, alpha: 1), isTranform: false)
    private let resultLabel = Label(icon: "", font: .systemFont(ofSize: 16, weight: .regular),
                                    textColor: #colorLiteral(red: 0.6159999967, green: 0.6159999967, blue: 0.6669999957, alpha: 1), isTranform: false)
