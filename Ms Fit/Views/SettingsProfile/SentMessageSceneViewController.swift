...
class SentMessageSceneViewController: BaseViewController<SentMessageSceneViewModel> {
    ...
    private let doneButton = specify(UIButton(type: .roundedRect), {
        ...
        $0.customButton(text: "حفظ", font: 20, weight: .bold, shadowColor: #colorLiteral(red: 0.5329999924, green: 0.3490000069, blue: 0.8899999857, alpha: 1), bgColor: #colorLiteral(red: 0.5329999924, green: 0.3490000069, blue: 0.8899999857, alpha: 1), isCircled: true)
    })
    ...
    private let yourRequestLabel = specify(UILabel(), {
        $0.text = "تم إرسال طلبكانتظري الرد خلال 48 ساعة"
